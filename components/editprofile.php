    ...
    <div class='p-2'>
        ...
        <div class='d-flex flex-column gap-2'>
            ...
            <div class="form-floating">
                ...
                <img id='showPassword3' src="<?= imagePath("web_images/icons","eye.png"); ?>" style='width:40px;height:40px;top:10px;right:10px' class='object-fit-cover position-absolute cursor-pointer'>
            </div>
        </div>
...
<script>
    ...
    showPassword1.on("click",()=>{
        const inputPassword = $("input[name=con_password]");
    ...
    const showPassword3 = $("#showPassword3");
    showPassword3.on("click",()=>{
        const inputPassword = $("input[name=c_password]");
        if(inputPassword.attr("type") == "password"){
            showPassword3.attr("src","<?= imagePath("web_images/icons","eye-slash.png"); ?>");
            inputPassword.attr("type","text")
        }else{
            showPassword3.attr("src","<?= imagePath("web_images/icons","eye.png"); ?>");
            inputPassword.attr("type","password")
        }
    })
</script>