...
<nav class="w-100 position-fixed z-99" style="top:10px;z-index:9" id="navbar">
    <div id="navbar-bg" class="container d-flex align-items-center p-4 position-relative justify-content-between rounded-2xl" style="backdrop-filter:blur(10px);background-image: linear-gradient(0deg,rgb(44, 128, 122), teal);height: 85px;">
