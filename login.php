...
<body>
    <a href="/" class='position-absolute text-white text-decoration-none' style='top:10px;left:10px'><- กลับ</a>
            ...
            <form action="api/auth.php" method='post' class='m-0' style='width:400px;'>
                ...
                <div class='d-flex flex-column gap-2 mb-2'>
                    ...
                    <div class="form-floating position-relative">
                        ...
                        <img id='showPassword' src="<?= imagePath("web_images/icons","eye.png"); ?>" style='width:40px;height:40px;top:10px;right:10px' class='object-fit-cover position-absolute cursor-pointer'>
                    </div>
                </div>
